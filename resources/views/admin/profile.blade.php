...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{url('auth/assets/fontawesome-free/css/all.min.css')}}">
  <!-- Theme style -->
  <link rel="stylesheet" href="{{url('auth/assets/css/adminlte.min.css')}}">
</head>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../../index3.html" class="nav-link">{{Auth::user()->rep_name}}</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
...
<script src="{{url('auth/assets/js/demo.js')}}"></script>
</body>
</html>
